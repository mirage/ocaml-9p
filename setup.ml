...
(* OASIS_START *)
(* DO NOT EDIT (digest: f9e44092975987f5f438c63db26aff93) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$test_parse_print", []))];
            ...
            [
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "build the Javascript client library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "protocol-9p";
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "protocol_9p";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\139c+\b\0111òç\136±\135Î5\127\157¼";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
